...
def build_ranked_cards(opportunities):
    ...
    for i, d in enumerate(opportunities):
        ...
        status_options = [
            ...
            ("4th_interview_scheduled", "4th Interview Scheduled"),
            ("4th_interview_held", "4th Interview Held"),
...
def build_app_rows(apps, include=None):
    ...
    status_order = {
        ...
        "4th_interview_held": 2.5,
        "4th_interview_scheduled": 2.7,
    ...
    for a in apps:
        ...
        status_map = {
            ...
            "4th_interview_held": ("4th Interview Held", "cyan"),
            "4th_interview_scheduled": ("4th Interview Scheduled", "cyan"),
...
<p style="font-size:12px;color:var(--text-muted);margin-bottom:14px;">Notes sent directly to a person (LinkedIn, email) with no application submitted. A company appears in the table above only when a real application went into their system; general-pile resume drops are noted here, not counted as applications.</p>
<div class="table-wrapper">
<table>
